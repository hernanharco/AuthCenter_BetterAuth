  ...
  return (
    <div className="w-full max-w-sm">
      <div className="bg-primary shadow-lg rounded-lg p-8 text-primary-foreground">
        <h1 className="text-3xl font-bold text-center mb-2">¡No pierdas tus transcripciones!</h1>
        <p className="text-center mb-6 text-primary-foreground/80">Completa el registro para guardar tu progreso.</p>
        ...
        <p className="text-center text-sm mt-6">
          ¿Ya tienes una cuenta? <Link href="/login" className="font-semibold hover:underline">Iniciar sesión</Link>
        </p>
      </div>
    </div>
  );
